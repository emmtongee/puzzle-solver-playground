...
def test_mrv_solve_contradictory_board():
    board = [
        [4, 8, 0, 0, 5, 0, 0, 2, 3], # 5th col 5 contradicts with 5 below
        [0, 5, 0, 0, 0, 0, 0, 6, 7],
        [0, 6, 0, 9, 0, 7, 4, 0, 1], 
    ...
    with pytest.raises(ValueError):
        mrv_solve_sudoku(board)

def test_mrv_solve_one_empty_cell():
    board = [
        [4, 8, 7, 6, 1, 5, 9, 2, 3], 
        [9, 5, 1, 3, 2, 4, 8, 6, 7], 
        [3, 6, 2, 9, 8, 7, 4, 5, 1], 
    ...
    solved_board, candidates_checked = mrv_solve_sudoku(board)

    assert solved_board[4][4] == 4
    assert candidates_checked > 0

def test_mrv_solve_unsolvable_board():
    board = [
        [4, 8, 1, 0, 0, 0, 0, 2, 3], 
        [0, 5, 0, 0, 0, 0, 0, 6, 7],
        [0, 6, 0, 9, 0, 7, 4, 0, 1], 
...
def test_mrv_solve_already_complete_board():
    board = [
        [4, 8, 7, 6, 1, 5, 9, 2, 3], 
        [9, 5, 1, 3, 2, 4, 8, 6, 7], 
        [3, 6, 2, 9, 8, 7, 4, 5, 1], 
